...
const file_proto_echo_proto_rawDesc = "" +
	...
	"\x04Echo\x122\n" +
	"\bSayHello\x12\x12.echo.HelloRequest\x1a\x10.echo.HelloReply\"\x00B6Z4github.com/ruokeqx/grpcdemo/grpcoveruds/proto/echopbb\x06proto3"
...
var file_proto_echo_proto_depIdxs = []int32{
	...
	1, // 1: echo.Echo.SayHello:output_type -> echo.HelloReply
